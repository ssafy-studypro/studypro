    ...
    >
      <template v-slot:activator="{ on }">
        <v-btn
          ...
          color="primary"
        >
          <span v-if="inputValue === ''">Click</span>
      ...
      <v-card class="v-date-range__menu-content">
        <v-card-text class="pa-0">
          ...
          >
            <v-card-text class="pa-0">
              <v-row class="pa-0">
                <v-col sm="6"><v-card-text class="py-0 text-center">Start Day</v-card-text></v-col>
                <v-col sm="6"><v-card-text class="py-0 text-center">End Day</v-card-text></v-col>
              </v-row>
              <v-date-picker
